		...
		for($x = 0; $x < count($_POST['productName']); $x++) {			
			...
			while ($updateProductQuantityResult = $updateProductQuantityData->fetch_row()) {
				$updateQuantity[$x] = $updateProductQuantityResult[0] - $_POST['quantity'][$x];							
					...
					// add into order_item
				$orderItemSql = "INSERT INTO order_item (order_id, product_id, quantity, rate, total ,hsncode,g_weight,huid,purity,n_weight,grate,hallmark,l_p_g, order_item_status) 
				VALUES ({$orderId}, '".$_POST['productName'][$x]."', '".$_POST['quantity'][$x]."', '".$_POST['rateValue'][$x]."', '".$_POST['totalValue'][$x]."','".$_POST['hsncode'][$x]."','".$_POST['g_weight'][$x]."','".$_POST['huid'][$x]."','".$_POST['purity'][$x]."','".$_POST['n_weight'][$x]."','".$_POST['grate'][$x]."','".$_POST['hallmark'][$x]."','".$_POST['l_p_g'][$x]."', 1)";

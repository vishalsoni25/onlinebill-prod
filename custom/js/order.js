...
function printOrder(orderId = null) {
	if(orderId) {		
		...
		var url = 'php_action/invoicePrint.php?orderid=' + encodeURIComponent(orderId);
		console.log(url);
		...
		success:function(response) {
			...
			var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+			  				
				...
				'<td style="padding-left:30px;display:none;">'+
					'<div class="form-group">'+
					'<input type="number" placeholder="HSN Code" name="hsncode[]" id="hsncode'+count+'" autocomplete="off" class="form-control"  />'+
					'</div>'+
				'</td>'+
				'<td style="padding-left:40px;">'+
					'<div class="form-group">'+
					'<input type="number" max="1000000" step=".01" min="0"  placeholder="G.weight"  name="g_weight[]" id="g_weight'+count+'"  onkeyup="getTotal('+count+')" autocomplete="off" class="form-control"  />'+
					'</div>'+
				'</td>'+
				'<td style="padding-left:40px;">'+
					'<div class="form-group">'+
				...
				'<td style="padding-left:40px;">'+
					'<div class="form-group">'+
					'<select type="number" placeholder="Purity" name="purity[]" id="purity'+count+'"  autocomplete="off" class="form-control" >'+
					'<option value="24K 999">24K</option>'+
					'<option value="22K 916">22K</option>'+
					'<option value="20k 833">20k</option>'+
					'<option value="18k 750">18k</option>'+
					'<option value="18k 585">14k</option>'+
					'<select/>'+
					'</div>'+
				'</td>'+
				'<td style="padding-left:40px;">'+
				...
				'<td style="padding-left:40px;">'+
					'<div class="form-group">'+
					'<input type="number"  placeholder="HallMark" name="hallmark[]" id="hallmark'+count+'"   onkeyup="getTotal('+count+')" autocomplete="off" class="form-control" value="45" />'+
					'</div>'+
				'</td>'+
				'<td style="padding-left:40px;">'+
					'<div class="form-group">'+
					'<input type="number"  placeholder="Labour/per" name="l_p_g[]" id="l_p_g'+count+'"   onkeyup="getTotal('+count+')" autocomplete="off" class="form-control"  />'+
					'</div>'+
				'</td>'+
		...
		if(productId == "") {
			...
			$.ajax({
				...
				success:function(response) {
					...
					total=(finalRate*n_weight)+hallmark;
					$("#total"+row).val(total);
...
function subAmount() {
	...
	// vat
	var vat = (Number($("#subTotal").val())/100) * 3;
	vat = vat.toFixed(2);
	$("#vat").val(vat);
	$("#vatValue").val(vat);
